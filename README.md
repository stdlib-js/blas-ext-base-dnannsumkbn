...
```javascript
import dnannsumkbn from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dnannsumkbn@v0.3.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn/actions/workflows/test.yml/badge.svg?branch=v0.3.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dnannsumkbn/actions/workflows/test.yml?query=branch:v0.3.0
